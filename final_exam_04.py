...
print('The top 10 Fl female names:\n\r\n\r', tenNamesList)
print()
# +++++++++++++++++++++++++++++++++++++ NEW CODE BEGINS +++++++++++++++++++++++++++++++++++++  
# +++++++++++++++++++++++++++++++++++++ NEW CODE BEGINS +++++++++++++++++++++++++++++++++++++  
# +++++++++++++++++++++++++++++++++++++ NEW CODE BEGINS +++++++++++++++++++++++++++++++++++++  
...
# constantly run into a problem 
# TypeError: list indices must be integers or slices, not str
# and couldn't figure what's wrong 
# so made it like the following:

nn = []
for i in range(len(tenNamesList)):
    nn.append(tenNamesList[i]['number'])
print('The sum of all Fl top 10 female name numbers is', sum(nn))